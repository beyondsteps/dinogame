...
def makePygame(name):
    ...
    dinoImg1 = pygame.image.load('dino1.png')
    dinoImg2 = pygame.image.load('dino2.png')

    dinoImg1 = pygame.transform.scale(dinoImg1, (60, 60))
    dinoImg2 = pygame.transform.scale(dinoImg2, (60, 60))
    ...
    #tree
    blockImg = pygame.image.load('tree.png')
